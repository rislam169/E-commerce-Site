...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $productupdate = $pd->updateProduct($_POST, $_FILES, $productid);
}
?>
<div class="grid_10">
...
$cat = new Category();
    ...
    if ($getcat) {
        while ($result = $getcat->fetch_assoc()) {
            ?>
                            <option
                            <?php if ($value['catId'] == $result['catId']) {echo "selected = 'selected'";}?> value="<?php echo $result['catId']; ?>"><?php echo $result['catName']; ?></option>
<?php }}?>
                        </select>
                    </td>
                </tr>
...
$br = new Brand();
    ...
    if ($getbrand) {
        while ($result = $getbrand->fetch_assoc()) {
            ?>
                            <option
                            <?php if ($value['brandId'] == $result['brandId']) {echo "selected = 'selected'";}?>
...
<?php }}?>
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?php echo $value['image']; ?>" height="80px" width="100px" alt=""><br>
