    ...
    while ($result = $getcat->fetch_assoc()) {
        ...
        ?>
						<tr class="odd gradeX">
							...
							<td><a href="catedit.php?catid=<?php echo $result['catId']; ?>">Edit</a> || <a onclick="return confirm('Are you sure to delete?')" href="?delcatid=<?php echo $result['catId']; ?>">Delete</a></td>
						</tr>
<?php }}?>
					</tbody>
				</table>
